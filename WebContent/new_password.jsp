...
<div class="login_body">
	...
	<form action="password_process.jsp" name="login_form" method="get">
	<input type="password" name="forget_password" placeholder="Password" /><br>
	<input type="password" name="forget_confirm_password" placeholder="Confirm Password" /><br>
	<input type="submit" name="otp_submit_button" value="Change Password" />
	</form>
	<a href="login.jsp?value=0">LogIn</a> Here<br>
	...
	<%
		...
		if(val.equals("98")){
			out.println("<h2 style='color:red'>Password Updated !!!</h2>");
		}
	%>
	</div>
</div>
