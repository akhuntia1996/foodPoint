...
<div class="login_body">
	...
	<h6>*Please check your email and verify your OTP</h6>
	<form action="otp_process.jsp" name="login_form" method="get">
	<input type="text" name="otp_entered" placeholder="Enter OTP" /><br>
	<input type="submit" name="otp_submit_button" value="Verify OTP" />
	</form>
