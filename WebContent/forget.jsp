...
<div class="forget_body">
	<div class="forget_body_inner">
	<h1>User Details:</h1>
	<form action="forget_process.jsp" name="forget_form" method="get">
	<input type="text" name="forget_username" placeholder="Username" /><br>
	<input type="email" name="forget_email" placeholder="Email Address" /><br>
	<select name="forget_mode" style="padding:10px">
	<option value="none">-- Mode Of Changing Password --</option>
	<option value="online">Online (Using Email)</option>
	<option value="offline">Offline</option>
	</select><br><br>
	<input type="submit" name="forget_submit_button" value="Continue" />
	</form><br>
	<a href="register.jsp?value=0">SignUp</a> Here<br>
	<%
		String val=request.getParameter("value");
		if(val.equals("99")){
			out.println("<h2 style='color:red'>Invalid Username or Email Address Entered !!!</h2>");
		}
		if(val.equals("98")){
			out.println("<h2 style='color:red'>Password Updated Successfully</h2>");
		}
		if(val.equals("90")){
			out.println("<h2 style='color:red'>Please Enter a Valid Mode</h2>");
		}
	%>
	</div>
</div>
