...
out.println("<tr><th>Food ID</th><th>Name</th><th>Photo</th><th>Price</th></tr>");
while(rs.next()){
	out.println("<tr><td>00"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td><a href='food_image.jsp?id="+rs.getInt(1)+"'>View Image</a></td><td>"+rs.getDouble(4)+"</td></tr>");
}
out.println("</table>");
